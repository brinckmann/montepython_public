...
class eff_like_from_covmat(Likelihood_prior):
    ...
    def loglkl(self, cosmo, data):
        ...
        mean_class_class = [cosmo.theta_s_100(),cosmo.get_current_derived_parameters(['100*theta_d'])['100*theta_d']]
        #mean_vec_class = np.array([eval(s) for s in self.get_var_strings]) list comprehension
